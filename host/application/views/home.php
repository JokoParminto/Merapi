...
nama tour and travel , tx travel tour promo , kia tour and travel , santorini tour package indonesia , 
franchise tour travel terbaik , kia tour travel , holiday tours & travel , holyland tour indonesia , 
new zealand tour package from indonesia , korea tour package from jakarta , dwidaya tour central park , 
dwidaya tour australia , europe tour indonesia , promo tour travel , tx travel tour korea , dwidaya tour singapore , 
tours and travels, tour packages , travel tours , travel tour companies , travel and tour , tour n travel , 
tours and travels website , group travel tours , tour dan travel , vacation tour companies , tour and travel companies , 
travel tour packages , website tour and travel , best travel tour companies , tour trip , tour & travels , 
...
<link rel=stylesheet type=text/css href="<?php echo site_url('resources/aio/css/bootstrap.css');?>">
<link rel=stylesheet type=text/css href="<?php echo site_url('resources/aio/fonts/font-awesome/css/font-awesome.css');?>">
<link href="<?php echo site_url('resources/aio/css/owl.carousel.css');?>" rel=stylesheet media=screen>
<link href="<?php echo site_url('resources/aio/css/owl.theme.css');?>" rel=stylesheet media=screen>
<link rel=stylesheet type=text/css href="<?php echo site_url('resources/aio/css/style.css');?>">
...
<script async type=text/javascript src="<?php echo site_url('resources/aio/js/modernizr.custom.js');?>"></script>
<!--[if lt IE 9]>
...
<section id=mal-home class=text-center style="background:url(<?php echo site_url('resources/aio/img/home.jpg');?>);background-size:cover;-moz-background-size:cover;-webkit-background-size:cover;background-position:center;background-attachment:fixed;background-repeat:no-repeat;color:#cfcfcf">
<div class=overlay>
<div class=content>
<div class=container>
<div class=row>
...
<section id=mal-book class=text-center style="background:url(<?php echo site_url('resources/aio/img/promo.jpg');?>);background-size:cover;background-position:center;background-attachment:fixed;background-repeat:no-repeat;color:#fff">
<div class=overlay>
<div class=container>
<div class=row>
...
<div class=type style="padding-left:50px 0 0 0">
...
<div class=price style="padding-left:50px 0 0 0">
...
<section id=mal-testimonials style="background:url(<?php echo site_url('resources/aio/img/testi.jpg');?>);background-size:cover;background-position:center;background-attachment:fixed;background-repeat:no-repeat;color:#fff" class=text-center>
<div class=overlay>
<div class=container>
<div class=row>
<div class=col-md-12>
...
<p>Wisata yang sangat menakjubkan dan juga menambah banyak pengalaman, mantap jiwa boskuh </p>
<small>Naufal Riza F.</small> </div>
</div>
</blockquote>
</div>
<div class=item>
...
<div class=row>
<div class="col-sm-8 col-sm-offset-2">
<p>Gila asik banget sumpah recomended banget guys pokoknya apalagi sunrisenya mantap jiwa </p>
<small>Refa</small> </div>
</div>
</blockquote>
</div>
<div class=item>
...
<div class=row>
<div class="col-sm-8 col-sm-offset-2">
<p>Ini beneran jogja ? kok beda yak keren banget pokoknya apalagi tripnya yang gile punya deh .</p>
<small>Anjar Setyawan</small> </div>
</div>
</blockquote>
</div>
<div class=item>
...
<div class=row>
<div class="col-sm-8 col-sm-offset-2">
<p>Wow Beautifull place destination deh ini pokoknya .</p>
<small>Nove</small> </div>
</div>
</blockquote>
</div>
...
<p class=usr-na>Naufal Riza F</p>
</li>
...
<p class=usr-na>Anjar Setyawan</p>
</li>
...
<section id=mal-contact class=text-center style="background:url(<?php echo site_url('resources/aio/img/footer.jpg');?>);background-size:cover;background-position:center;background-attachment:fixed;background-repeat:no-repeat;color:#fff">
<div class=overlay>
<div class=container>
...
<strong>Marketing</strong><br>
<strong>Mbak Wal</strong><br>
<abbr title=Phone>Contact</br>
<i class="fa fa-phone" aria-hidden=true></i>
<i class="fa fa-whatsapp" aria-hidden=true></i></abbr> 0859-2748-9531 </br>
<strong>Pak Rukimin</strong><br>
<abbr title=Phone>Contact</br>
<i class="fa fa-phone" aria-hidden=true></i>
<i class="fa fa-whatsapp" aria-hidden=true></i></abbr> 0878-3999-8000 </br>
<strong>Mas Mur</strong><br>
<abbr title=Phone>Contact</abbr></br>
<i class="fa fa-phone" aria-hidden=true></i>
<i class="fa fa-whatsapp" aria-hidden=true></i>
0812-8464-3000 </br> <i class="fa fa-phone" aria-hidden=true></i>
<i class="fa fa-whatsapp" aria-hidden=true></i> 0817-5482-2600
</address>
</div>
</div>
</div>
...
<script type=text/javascript src="<?php echo site_url('resources/aio/js/jquery.isotope.js');?>"></script>
<script src="<?php echo site_url('resources/aio/js/owl.carousel.js');?>"></script>
<script type=text/javascript src="<?php echo site_url('resources/aio/js/main.js');?>"></script>
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109740438-1"></script>
<script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}
gtag('js',new Date());gtag('config','UA-109740438-1');</script>
<script>document.onkeydown=function(e){if(event.keyCode==123){return false;}
if(e.ctrlKey&&e.shiftKey&&e.keyCode=='I'.charCodeAt(0)){return false;}
if(e.ctrlKey&&e.shiftKey&&e.keyCode=='J'.charCodeAt(0)){return false;}
if(e.ctrlKey&&e.keyCode=='U'.charCodeAt(0)){return false;}}</script>
</body>
</html>
