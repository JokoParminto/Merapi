    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">M Photo Add</h3>
            </div>
            <?php echo form_open('m_photo/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="nama_photo" class="control-label"><span class="text-danger">*</span>Nama Photo</label>
						<div class="form-group">
							<input type="text" name="nama_photo" value="<?php echo $this->input->post('nama_photo'); ?>" class="form-control" id="nama_photo" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="desc_photo" value="<?php echo $this->input->post('desc_photo'); ?>" class="form-control" id="desc_photo" />
